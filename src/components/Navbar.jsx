...
const Navbar = () => {
  const { currentColor, activeMenu, setActiveMenu, isClicked, handleClick, setIsClicked, setScreenSize, screenSize } = useStateContext();
  ...
  return (
      <div className="flex justify-between p-2 md:mx-6 relative">
        ...
        <div className="flex">
          ...
          dotColor="#03C9D7"
          customFunc={() => handleClick('notififcation')}
          color="blue" 
